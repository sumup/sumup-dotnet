...
public sealed partial class CheckoutsProcessResponse
{
    ...
    public CheckoutsProcessResponsePaymentInstrument? PaymentInstrument { get; set; }
    ...
    public CheckoutsProcessResponseStatus? Status { get; set; }
    ...
    public IEnumerable<CheckoutsProcessResponseTransactionsItem>? Transactions { get; set; }
